...
from third_party.tvl.tvl_llama.llama.llama_adapter import LLaMA_adapter
...
def main(args):
    ...
    model = LLaMA_adapter(llama_ckpt_dir, llama_tokenzier_path, phase="pretrain", args=args)
