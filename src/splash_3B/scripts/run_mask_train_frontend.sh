...
MASK_PATH="${ROOT_DIR}/src/masks/${SPARSITY}/mask_wanda_skip.pt"
...
OUTPUT_DIR="${ROOT_DIR}/src/outputs0510/tvl_frontend_${SPARSITY}_tvl_enc_vittiny"
...
torchrun \
    ...
    src/stage2_mask_train_frontend.py \
    ...
    --deepspeed "$DS_CONFIG" \
    --run_name "${SPARSITY}_tvl_frontend_tvl_enc_vittiny" \
