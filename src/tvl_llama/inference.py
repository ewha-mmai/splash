...
from third_party.tvl.tvl_llama.llama.llama_adapter import load
from src.util import tactile_preprocess as tacvis
from third_party.tvl.tvl_llama import llama
...
def parse_args():
    ...
    parser.add_argument("--tactile_model", type=str, default="vit_small_patch16_224")
