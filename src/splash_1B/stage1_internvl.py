...
MODEL_ID = os.path.join(root_dir, "pretrained/InternVL2_5-1B")
...
SAVE_DIR = os.path.join(root_dir, f"src/masks/{int(PRUNING_RATIO * 100)}_internvl")
...
def generate_weight_wanda_mask(model, tokenizer):
...
if __name__ == "__main__":
    print(f" Loading InternVL2.5-1B Model...")
    ...
    generate_weight_wanda_mask(model, tokenizer)
