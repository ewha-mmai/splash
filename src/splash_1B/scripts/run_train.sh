...
STUDENT_PATH="${ROOT_DIR}/checkpoints/InternVL2_5-1B"
MASK_PATH="${ROOT_DIR}/src/splash_1B/masks/${SPARSITY}.pt"
...
OUTPUT_DIR="${ROOT_DIR}/src/splash_1B/outputs/${SPARSITY}"
